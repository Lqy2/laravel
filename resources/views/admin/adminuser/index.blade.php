    ...
    <table class="layui-table" lay-skin="line">
        ...
        <tbody>
            ...
            <tr class="j-pid-{{ $v->pid }}" @if($v->level)style="display:none"@endif>
                ...
                <td style="text-align: center;">
                    <a href="{{url('adminuserlist/edit', ['id' => $v->id ])}}" class="layui-btn layui-btn-sm layui-btn-normal" style="margin-right:5px;">编辑</a>
                    <a href="{{url('adminuserlist/delete', ['id' => $v->id ])}}" class="layui-btn layui-btn-sm layui-btn-danger j-del ">删除</a>
                </td>
            </tr>
            @endforeach
            @if(empty($arr))
